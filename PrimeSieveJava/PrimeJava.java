  ...
  public static class PrimeSieve {
    ...
    public boolean validateResults() {
      if (this.myDict.containsKey(this.sieveSize))
        return this.myDict.get(this.sieveSize).intValue() == this.countPrimes();
      return false;
    }
    ...
    public void printResults(final boolean showResults, final double duration, final long passes) {
      ...
      if (showResults)
        System.out.println("");
      System.out.println("Passes: " + passes + ", Time: " + duration + ", Avg: "
          + (duration / passes) + ", Limit: " + sieveSize + ", Count: " + count + ", Valid: "
